...
/*
RetrieveInstancesAuditsList Retrieve a list of your custom images history

To view the audit history of your instances that were manipulated through the API, you can access a list of these actions.
