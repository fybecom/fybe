...
// The API call&#39;s requestId that triggered the modification.
...
/*
RetrieveSecretAuditsList Display history about your secrets (audit)

Displays chronical overview about your secrets using filters.
