...
type UpdateTagRequest struct {
	// Tags are identified by this name which can include letters, numbers, colons, dashes, and underscores. The name of a tag is restricted to a maximum of 255 characters.
