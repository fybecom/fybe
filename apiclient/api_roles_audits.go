...
// The &#x60;changedBy&#x60; field indicates the user who made the change.
...
// The end time of the time range being searched.
...
/*
RetrieveRoleAuditsList Retrieve the audit history of your roles.

Retrieve a list of your role history, with the ability to filter the results based on specific criteria.
