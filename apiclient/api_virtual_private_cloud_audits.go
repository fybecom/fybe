...
// VirtualPrivateCloudAuditsApiService VirtualPrivateCloudAuditsApi service
type VirtualPrivateCloudAuditsApiService service

type ApiRetrievePrivateNetworkAuditsListRequest struct {
	ctx _context.Context
	ApiService *VirtualPrivateCloudAuditsApiService
	xRequestId *string
	xTraceId *string
	page *int64
	size *int64
...
// The Id of the API call that triggered the change.
...
/*
RetrievePrivateNetworkAuditsList List history of your VPCs (audit)

Displays the history to your Virtual Private Clouds using filters.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRetrievePrivateNetworkAuditsListRequest
*/
func (a *VirtualPrivateCloudAuditsApiService) RetrievePrivateNetworkAuditsList(ctx _context.Context) ApiRetrievePrivateNetworkAuditsListRequest {
	return ApiRetrievePrivateNetworkAuditsListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *VirtualPrivateCloudAuditsApiService) RetrievePrivateNetworkAuditsListExecute(r ApiRetrievePrivateNetworkAuditsListRequest) (ListPrivateNetworkAuditResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VirtualPrivateCloudAuditsApiService.RetrievePrivateNetworkAuditsList")
	if err != nil {
