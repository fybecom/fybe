...
// CreateTicketResponseData struct for CreateTicketResponseData
...
func (o CreateTicketResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateTicketResponseData struct {
	value *CreateTicketResponseData
	isSet bool
}

func (v NullableCreateTicketResponseData) Get() *CreateTicketResponseData {
	return v.value
}

func (v *NullableCreateTicketResponseData) Set(val *CreateTicketResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTicketResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTicketResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTicketResponseData(val *CreateTicketResponseData) *NullableCreateTicketResponseData {
	return &NullableCreateTicketResponseData{value: val, isSet: true}
}

func (v NullableCreateTicketResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTicketResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
