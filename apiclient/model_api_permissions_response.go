...
type ApiPermissionsResponse struct {
	// This refers to the API endpoint. To obtain a list of available API endpoints, please refer to the GET api-permissions endpoint.
	ApiName string `json:"apiName"`
	// This specifies the permitted action for the API endpoint. Generally, CREATE corresponds to POST endpoints, READ to GET endpoints, UPDATE to PATCH/PUT endpoints, and DELETE to DELETE endpoints.
