...
type CreateObjectStorageRequest struct {
	...
	// The display name is useful to distinguish between different object storages, e.g. when they are located in the same region. If the customer does not provide a unique display name, it will be generated. Display names can be adapted at any time.
