...
type PermissionResponse struct {
	// To obtain a list of available API endpoints, please refer to the GET api-permissions endpoint. This will help identify the required API endpoint.
	ApiName string `json:"apiName"`
	// The action that is permitted for the API endpoint. Typically, CREATE corresponds to POST endpoints, READ to GET endpoints, UPDATE to PATCH/PUT endpoints, and DELETE to DELETE endpoints.
