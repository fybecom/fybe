...
type CreateTagRequest struct {
	// This title of the tag might consist of letters, numbers, colons, dashes, and underscores, with a maximum length of 255 characters..
	Name string `json:"name"`
	// Tags can be assigned a color using a hexadecimal value. The default color for a tag is #0A78C3.
