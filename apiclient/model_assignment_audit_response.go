...
type AssignmentAuditResponse struct {
	...
	// The resource type identifier specifies whether the resource pertains to an `instance`, `image`, or `object-storage`.
	ResourceType string `json:"resourceType"`
	// Identifier of the Tag
	TagId float32 `json:"tagId"`
	// Action Type of the Audit
	...
	// Changes that were made for a particular Tag
