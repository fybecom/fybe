...
// The Identifier of the API call request that made the change.
...
/*
RetrieveAssignmentsAuditsList List a history about the assignments (audit)

Displays the history about your assignments using filters.
