...
type CreateInstanceRequest struct {
	// Specify the ImageId to set up the compute instance. The default value is Ubuntu 20.04.
	...
	// The initial contract period is measured in months and offers options of 1, 3, 6, or 12 months. The default period is 1 month.
...
func NewCreateInstanceRequestWithDefaults() *CreateInstanceRequest {
	this := CreateInstanceRequest{}
	var imageId string = "31800cb5-6592-4d39-984d-36d433c06efb"
	this.ImageId = imageId
