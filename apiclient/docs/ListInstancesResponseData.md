...
**DisplayName** | **string** | The customer name by which the compute instance is represented | 
**InstanceId** | **int64** | Identifier of the compute instance | 
...
**CreatedDate** | **time.Time** | The date on which the compute instance was created | 
**CancelDate** | **string** | The date when the compute instance is to be terminated | 
...
**ProductType** | **string** | The category to which the instance belongs based on its ProductId. | 
...
`func (o *ListInstancesResponseData) GetIpConfig() IpConfig`
