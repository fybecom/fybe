...
// DatacenterCapabilities the model 'DatacenterCapabilities'
type DatacenterCapabilities string

// List of DatacenterCapabilities
const (
	OBJECT_STORAGE DatacenterCapabilities = "Object-Storage"
	PRIVATE_NETWORKING DatacenterCapabilities = "Private-Networking"
)

var allowedDatacenterCapabilitiesEnumValues = []DatacenterCapabilities{
	"Object-Storage",
	"Private-Networking",
}

func (v *DatacenterCapabilities) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := DatacenterCapabilities(value)
	for _, existing := range allowedDatacenterCapabilitiesEnumValues {
	...
	return fmt.Errorf("%+v is not a valid DatacenterCapabilities", value)
}

// NewDatacenterCapabilitiesFromValue returns a pointer to a valid DatacenterCapabilities
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewDatacenterCapabilitiesFromValue(v string) (*DatacenterCapabilities, error) {
	ev := DatacenterCapabilities(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for DatacenterCapabilities: valid values are %v", v, allowedDatacenterCapabilitiesEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v DatacenterCapabilities) IsValid() bool {
	for _, existing := range allowedDatacenterCapabilitiesEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to DatacenterCapabilities value
func (v DatacenterCapabilities) Ptr() *DatacenterCapabilities {
	return &v
}

type NullableDatacenterCapabilities struct {
	value *DatacenterCapabilities
	isSet bool
}

func (v NullableDatacenterCapabilities) Get() *DatacenterCapabilities {
	return v.value
}

func (v *NullableDatacenterCapabilities) Set(val *DatacenterCapabilities) {
	v.value = val
	v.isSet = true
}

func (v NullableDatacenterCapabilities) IsSet() bool {
	return v.isSet
}

func (v *NullableDatacenterCapabilities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatacenterCapabilities(val *DatacenterCapabilities) *NullableDatacenterCapabilities {
	return &NullableDatacenterCapabilities{value: val, isSet: true}
}

func (v NullableDatacenterCapabilities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatacenterCapabilities) UnmarshalJSON(src []byte) error {
	v.isSet = true
