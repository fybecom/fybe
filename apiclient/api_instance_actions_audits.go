...
// The ID of the compute instancesActions.
...
To obtain a log of the actions you initiated via the API, you can access a list of these actions. This list serves as a record of your API-triggered actions, also known as audit history
