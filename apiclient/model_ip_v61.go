...
func (o IpV61) MarshalJSON() ([]byte, error) {
...
type NullableIpV61 struct {
	value *IpV61
	isSet bool
}

func (v NullableIpV61) Get() *IpV61 {
	return v.value
}

func (v *NullableIpV61) Set(val *IpV61) {
	v.value = val
	v.isSet = true
}

func (v NullableIpV61) IsSet() bool {
	return v.isSet
}

func (v *NullableIpV61) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpV61(val *IpV61) *NullableIpV61 {
	return &NullableIpV61{value: val, isSet: true}
}

func (v NullableIpV61) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpV61) UnmarshalJSON(src []byte) error {
	v.isSet = true
