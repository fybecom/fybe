...
type UpgradeObjectStorageResponseData struct {
	...
	// Creation date of the object storage.
	CreatedDate string `json:"createdDate"`
	// Location of Data center of the object storage.
	DataCenter string `json:"dataCenter"`
	// The limit for object storage when using autoscaling.
	AutoScaling AutoScalingTypeResponse `json:"autoScaling"`
	// URL to connect to your S3 compatible Fybe object storage
	S3Url string `json:"s3Url"`
	// Current status of the object storage.
	Status string `json:"status"`
	// Total object storage that was purchased by the customer (in terabytes).
	TotalPurchasedSpaceTB float64 `json:"totalPurchasedSpaceTB"`
	// Location of customers object storage.
